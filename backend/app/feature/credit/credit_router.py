...
from app.feature.credit.credit_dependencies import get_credit_service
from app.feature.credit.credit_dto import PaginatedCreditOutputDTO
from app.feature.credit.credit_service import CreditService
...
async def get_credit(
    ...
    uow: CreditUoWPort = Depends(get_credit_uow),
